...
export function useAddNodeOnEdgeDrop() {
    ...
    const handleAddConnectedNode = useCallback(
        ...
        [insertNode, addEdges, setShowMenu, setIncomingNodeMetadetails, incomingNodeMetadetails, dropPosition],
    );
    ...
    const onConnectEnd = useCallback(
        ...
        [setAnchorPosition, setBuilderBlur, setShowMenu, setIncomingNodeMetadetails, screenToFlowPosition, floatingMenuWrapperRef, setDropPosition],
    );
